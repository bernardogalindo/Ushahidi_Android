 ...
 */
public class ActionBarHelperBase extends BaseActionBarHelper {
    ...
    public void onPostCreate(Bundle savedInstanceState) {
        Log.i("ActionBarHelperBase","onPostCreate");
    ...
    private void setupActionBar() {
        final ViewGroup actionBarCompat = getActionBar();
    ...
    public void onTitleChanged(CharSequence title, int color) {
        TextView titleView = (TextView)mActivity.findViewById(R.id.actionbar_title);
        if (titleView != null) {
    ...
    public void setRefreshActionItemState(boolean refreshing) {
        View refreshButton = mActivity.findViewById(R.id.actionbar_item_refresh);
        View refreshIndicator = mActivity.findViewById(R.id.actionbar_item_refresh_progress);
